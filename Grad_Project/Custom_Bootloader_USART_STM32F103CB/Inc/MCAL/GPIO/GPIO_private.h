...
typedef struct
{
	...
	*/
	...
	/*
		...
		This Register Gives Alternative Solution to ODR Register as It Allows Pin Bit Access unlike ODR WordMode Only
...
/*			ALL GPIO OUTPUT MODE STATE OPTIONS								   */
#define     ALL_GPIO_LOW                                   0x0000
#define     ALL_GPIO_HIGH                                  0xFFFF

/*			ALL GPIO INPUT MODE PULL_UP_DOWN CONFIGURATION OPTIONS			   */
#define     ALL_GPIO_INPUT_MODE_CNF_PULL_UP                0x0000
#define     ALL_GPIO_INPUT_MODE_CNF_PULL_DOWN              0xFFFF
/* ---------------------------------------------------------------------------------------------------------- */

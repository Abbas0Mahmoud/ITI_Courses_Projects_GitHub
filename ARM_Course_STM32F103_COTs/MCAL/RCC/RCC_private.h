...
typedef struct
{
	/*
		...
		Choose one of Three Clock Sources to Turn On
		Checking if The Selected Clock Source is Ready of Not
		Getting HSI Factory Calibration Loaded Value
		Trimming HSI Value through Trimming Bits
